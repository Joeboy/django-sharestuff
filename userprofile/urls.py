...
urlpatterns = patterns('',
    ...
    url(r'^edit-offer/(?P<thing_id>[\d+])/$', 'userprofile.views.edit_offer', name="edit_offer"),
    url(r'^delete-offer/(?P<thing_id>[\d+])/$', 'userprofile.views.delete_offer', name="delete_offer"),
)
